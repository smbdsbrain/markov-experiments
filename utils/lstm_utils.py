...
def get_dataset(raw_text):
    ...
    dataInput, dataOutput = get_input_output(raw_text, n_chars, char_to_int, sequence_length)
...
def get_input_output(text, n_chars, char_to_int, sequence_length):
    input = []
    output = []
